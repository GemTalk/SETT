...
Blob type 3 appears to be for multi-byte strings. Encoding is something like this:

Character:
1: End of character, which preceded. If no preceding character, value of 0.
2: Subtract 16r20 from following byte -- used for 16r00 - 16r0F.
3: ? Not observed yet.
